...
<h2>**Đồ án Tốt nghiệp** — Hệ thống thương mại điện tử tích hợp trí tuệ nhân tạo hỗ trợ tư vấn thời trang và cá nhân hóa trải nghiệm mua sắm.</h2>
<p><strong>Sinh viên thực hiện: Nguyễn Huy Công</strong></p>
...
|---|---|---|
| Admin | `huycong` | `huycong1234` |
| Người dùng | `kh1` | `huycong1234` |
...
⭐ Nếu dự án hữu ích, hãy để lại một **Star** để ủng hộ mình nhé!

**© 2026 — Đồ án Tốt nghiệp | Hệ Thống Bán Hàng Online Thông Minh**
